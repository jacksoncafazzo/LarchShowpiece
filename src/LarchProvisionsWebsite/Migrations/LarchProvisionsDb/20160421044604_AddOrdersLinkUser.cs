...
{
    public partial class AddOrdersLinkUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(name: "FK_Ingredient_Recipe_RecipeId", table: "Ingredients");
            migrationBuilder.DropForeignKey(name: "FK_Menu_Recipe_RecipeRecipeId", table: "Menus");
            migrationBuilder.DropColumn(name: "RecipeRecipeId", table: "Menus");
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LarchCustomerId = table.Column<int>(nullable: false),
                    LarchCustomerId1 = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ApplicationUser_LarchCustomerId1", x => x.LarchCustomerId1);
                });
            migrationBuilder.CreateTable(
                name: "AspNetRoles",
                columns: table => new
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Recipe_Menu_MenuId", table: "Recipes");
            migrationBuilder.DropColumn(name: "MenuId", table: "Recipes");
